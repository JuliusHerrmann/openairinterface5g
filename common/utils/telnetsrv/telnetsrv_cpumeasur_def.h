...
#define CPU_PHYENB_MEASURE                                                                                                        \
  {                                                                                                                               \
    {"phy_proc_tx", &(phyvars->phy_proc_tx), 0, 1}, {"phy_proc_rx", &(phyvars->phy_proc_rx), 0, 1},                               \
        {"rx_prach", &(phyvars->rx_prach), 0, 1}, {"ofdm_mod", &(phyvars->ofdm_mod_stats), 0, 1},                                 \
        {"dlsch_common_and_dci", &(phyvars->dlsch_common_and_dci), 0, 1},                                                         \
        {"dlsch_ue_specific", &(phyvars->dlsch_ue_specific), 0, 1}, {"dlsch_encoding", &(phyvars->dlsch_encoding_stats), 0, 1},   \
        ...
        {"dlsch_interleaving", &(phyvars->dlsch_interleaving_stats), 0, 1}, {"rx_dft", &(phyvars->rx_dft_stats), 0, 1},           \
        ...
        {"ulsch_demultiplexing", &(phyvars->ulsch_demultiplexing_stats), 0, 1}, {"ulsch_llr", &(phyvars->ulsch_llr_stats), 0, 1}, \
        {"ulsch_tc_init", &(phyvars->ulsch_tc_init_stats), 0, 1}, {"ulsch_tc_alpha", &(phyvars->ulsch_tc_alpha_stats), 0, 1},     \
        {"ulsch_tc_beta", &(phyvars->ulsch_tc_beta_stats), 0, 1}, {"ulsch_tc_gamma", &(phyvars->ulsch_tc_gamma_stats), 0, 1},     \
        {"ulsch_tc_ext", &(phyvars->ulsch_tc_ext_stats), 0, 1}, {"ulsch_tc_intl1", &(phyvars->ulsch_tc_intl1_stats), 0, 1},       \
        {"ulsch_tc_intl2", &(phyvars->ulsch_tc_intl2_stats), 0, 1},                                                               \
  }

#define CPU_MACENB_MEASURE                                                                                      \
  {                                                                                                             \
    {"eNB_scheduler", &(macvars->eNB_scheduler), 0, 1}, {"schedule_si", &(macvars->schedule_si), 0, 1},         \
        {"schedule_ra", &(macvars->schedule_ra), 0, 1}, {"schedule_ulsch", &(macvars->schedule_ulsch), 0, 1},   \
        {"fill_DLSCH_dci", &(macvars->fill_DLSCH_dci), 0, 1},                                                   \
        {"schedule_dlsch_pre", &(macvars->schedule_dlsch_preprocessor), 0, 1},                                  \
        {"schedule_dlsch", &(macvars->schedule_dlsch), 0, 1}, {"schedule_mch", &(macvars->schedule_mch), 0, 1}, \
        {"rx_ulsch_sdu", &(macvars->rx_ulsch_sdu), 0, 1}, {"schedule_pch", &(macvars->schedule_pch), 0, 1},     \
  }
