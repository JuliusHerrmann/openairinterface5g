...
typedef enum { NFAPI_CSI_REPORT_TYPE_PERIODIC = 0, NFAPI_CSI_REPORT_TYPE_APERIODIC } nfapi_csi_report_type_e;
...
typedef enum { NFAPI_CP_NORMAL = 0, NFAPI_CP_EXTENDED = 1 } nfapi_cyclic_prefix_type_e;
...
typedef enum { NFAPI_LBT_DL_RSP_PDSCH_PDU_TYPE = 0, NFAPI_LBT_DL_RSP_DRS_PDU_TYPE } nfapi_lbt_dl_rsp_pdu_type_e;
...
typedef enum { NFAPI_IP_ADDRESS_IPV4 = 0, NFAPI_IP_ADDRESS_IPV6 } nfapi_ip_address_type_e;
...
typedef struct nfapi_p7_codec_config {
   ...
   */
  int (*unpack_p7_vendor_extension)(nfapi_p7_message_header_t* header,
                                    uint8_t** ppReadPackedMsg,
                                    uint8_t* end,
                                    struct nfapi_p7_codec_config* config);
   ...
   *  If the message if is unknown the function should return -1
   */
  int (*pack_p7_vendor_extension)(nfapi_p7_message_header_t* header,
...
typedef struct nfapi_p4_p5_codec_config {
   ...
   * If not set the message will be ignored
   */
  int (*unpack_p4_p5_vendor_extension)(nfapi_p4_p5_message_header_t* header,
                                       uint8_t** ppReadPackedMsg,
                                       uint8_t* end,
                                       struct nfapi_p4_p5_codec_config* config);
   ...
   *  If not set the the message will be ingored
   */
  int (*pack_p4_p5_vendor_extension)(nfapi_p4_p5_message_header_t* header,
                                     uint8_t** ppwritepackedmsg,
                                     uint8_t* end,
                                     struct nfapi_p4_p5_codec_config* config);
