...
//  /* assoc_id */
    ...
    //         *)ie->value.choice.MCE_MBMS_Configuration_data_List.list.array[i])->value.choice.MCE_MBMS_Configuration_data_Item);
    //    /* eCGI */
    ...
    //   for(j=0;j<1;j++){
    //       //OCTET_STRING_TO_INT16(&(mbms_configuration_item_p->mbmsServiceAreaList.list.array[j]),
    //       M3AP_SETUP_REQ(message_p).service_area_id[i][j]);
    //   }
    //
    // }
    //
    ...
    ////    // System Information
    ////    /* mib */
    ////    M3AP_SETUP_REQ(message_p).mib[i] = calloc(served_celles_item_p->gNB_DU_System_Information->mIB_message.size + 1,
    /// sizeof(char)); /    memcpy(M3AP_SETUP_REQ(message_p).mib[i],
    /// served_celles_item_p->gNB_DU_System_Information->mIB_message.buf, /
    /// served_celles_item_p->gNB_DU_System_Information->mIB_message.size); /    /* Convert the mme name to a printable string */ /
    /// M3AP_SETUP_REQ(message_p).mib[i][served_celles_item_p->gNB_DU_System_Information->mIB_message.size] = '\0'; /
    /// M3AP_SETUP_REQ(message_p).mib_length[i] = served_celles_item_p->gNB_DU_System_Information->mIB_message.size; / LOG_D(M3AP,
    ///"M3AP_SETUP_REQ(message_p).mib[%d] %s , len = %d \n", /          i, M3AP_SETUP_REQ(message_p).mib[i],
    /// M3AP_SETUP_REQ(message_p).mib_length[i]);
    ////
    ////    /* sib1 */
    ////    M3AP_SETUP_REQ(message_p).sib1[i] = calloc(served_celles_item_p->gNB_DU_System_Information->sIB1_message.size + 1,
    /// sizeof(char)); /    memcpy(M3AP_SETUP_REQ(message_p).sib1[i],
    /// served_celles_item_p->gNB_DU_System_Information->sIB1_message.buf, /
    /// served_celles_item_p->gNB_DU_System_Information->sIB1_message.size); /    /* Convert the mme name to a printable string */ /
    /// M3AP_SETUP_REQ(message_p).sib1[i][served_celles_item_p->gNB_DU_System_Information->sIB1_message.size] = '\0'; /
    /// M3AP_SETUP_REQ(message_p).sib1_length[i] = served_celles_item_p->gNB_DU_System_Information->sIB1_message.size; / LOG_D(M3AP,
    ///"M3AP_SETUP_REQ(message_p).sib1[%d] %s , len = %d \n", /          i, M3AP_SETUP_REQ(message_p).sib1[i],
    /// M3AP_SETUP_REQ(message_p).sib1_length[i]); /  }
    //
    //
