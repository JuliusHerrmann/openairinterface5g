...
int MCE_send_MBMS_SCHEDULING_INFORMATION(instance_t instance, /*sctp_assoc_t assoc_id,*/ m2ap_mbms_scheduling_information_t * m2ap_mbms_scheduling_information)
{
  ...
  for(i=0; i < m2ap_mbms_scheduling_information->num_mbms_area_config_list; i++){ 
      ...
      M2AP_PMCH_Configuration_ItemIEs_t *pmch_configuration_item_ies =
          (M2AP_PMCH_Configuration_ItemIEs_t *)calloc(1, sizeof(M2AP_PMCH_Configuration_ItemIEs_t));
      ...
      M2AP_PMCH_Configuration_Item_t
      ...
      pmch_configuration_item = &pmch_configuration_item_ies->value.choice.PMCH_Configuration_Item;
      {
       ...
       for (k = 0; k < m2ap_mbms_scheduling_information->mbms_area_config_list[i].pmch_config_list[j].num_mbms_session_list; k++) {
         ...
         // m2ap_mbms_scheduling_information->mbms_area_config_list[i].pmch_config_list[j].mbms_session_list[k].lcid,sizeof(member->lcid),sizeof(m2ap_mbms_scheduling_information->mbms_area_config_list[i].pmch_config_list[j].mbms_session_list[k].lcid));
         // long kk = m2ap_mbms_scheduling_information->mbms_area_config_list[i].pmch_config_list[j].mbms_session_list[k].lcid;
         // uint64_t
         // kk=(m2ap_mbms_scheduling_information->mbms_area_config_list[i].pmch_config_list[j].mbms_session_list[k].lcid);
      ...
      //(mbsfn_area_configuration_item_ie+1)
      ...
      M2AP_MBSFN_Subframe_ConfigurationItem_t *mbsfn_subframe_configuration_item_ies =
          (M2AP_MBSFN_Subframe_ConfigurationItem_t *)calloc(1, sizeof(M2AP_MBSFN_Subframe_ConfigurationItem_t));
      ...
      mbsfn_subframe_configuration_item_ies->value.present =
      ...
      M2AP_MBSFN_Subframe_Configuration_t *
          mbsfn_subframe_configuration; /* =
                                           (M2AP_MBSFN_Subframe_Configuration_t*)calloc(1,sizeof(M2AP_MBSFN_Subframe_Configuration_t));*/
      mbsfn_subframe_configuration = &mbsfn_subframe_configuration_item_ies->value.choice.MBSFN_Subframe_Configuration;
      {
       mbsfn_subframe_configuration->radioframeAllocationPeriod =
           m2ap_mbms_scheduling_information->mbms_area_config_list[i].mbms_sf_config_list[j].radioframe_allocation_period;
       mbsfn_subframe_configuration->radioframeAllocationOffset =
       ...
       if (m2ap_mbms_scheduling_information->mbms_area_config_list[i].mbms_sf_config_list[j].is_four_sf) {
         ...
         mbsfn_subframe_configuration->subframeAllocation.present =
       ...
       asn1cSeqAdd(&(mbsfn_area_configuration_item_ie_1)->value.choice.MBSFN_Subframe_ConfigurationList.list,
                   mbsfn_subframe_configuration_item_ies);
      }
       }
...
int MCE_handle_M2_SETUP_REQUEST(instance_t instance, sctp_assoc_t assoc_id, uint32_t stream, M2AP_M2AP_PDU_t *pdu)
{
 ...
 // this function exits if the ie is mandatory
  ...
  memcpy(M2AP_SETUP_REQ(message_p).ENBname, ie->value.choice.ENBname.buf, ie->value.choice.ENBname.size);
  ...
  for (i = 0; i < num_mbms_available; i++) {
      ...
      mbms_configuration_item_p =
          &(((M2AP_ENB_MBMS_Configuration_data_ItemIEs_t *)ie->value.choice.ENB_MBMS_Configuration_data_List.list.array[i])
                ->value.choice.ENB_MBMS_Configuration_data_Item);
      /* eCGI */
  ...
  //    // System Information
  //    /* mib */
  //    M2AP_SETUP_REQ(message_p).mib[i] = calloc(served_celles_item_p->gNB_DU_System_Information->mIB_message.size + 1,
  //    sizeof(char)); memcpy(M2AP_SETUP_REQ(message_p).mib[i], served_celles_item_p->gNB_DU_System_Information->mIB_message.buf,
  ...
  //
  //    /* sib1 */
  //    M2AP_SETUP_REQ(message_p).sib1[i] = calloc(served_celles_item_p->gNB_DU_System_Information->sIB1_message.size + 1,
  //    sizeof(char)); memcpy(M2AP_SETUP_REQ(message_p).sib1[i], served_celles_item_p->gNB_DU_System_Information->sIB1_message.buf,
...
int MCE_send_M2_SETUP_RESPONSE(instance_t instance, /*sctp_assoc_t assoc_id,*/
  ...
  MCC_MNC_TO_PLMNID(m2ap_setup_resp->mcc,
                    m2ap_setup_resp->mnc,
                    m2ap_setup_resp->mnc_digit_length,
  ...
  for( i=0; i < m2ap_setup_resp->num_mcch_config_per_mbsfn; i++) 
  {
    ...
    mcch_related_bcch_config_per_mbsfn_area_item_ies =
        (M2AP_MCCHrelatedBCCH_ConfigPerMBSFNArea_ItemIEs_t *)calloc(1, sizeof(M2AP_MCCHrelatedBCCH_ConfigPerMBSFNArea_ItemIEs_t));
    ...
    mcch_related_bcch_config_per_mbsfn_area_item_ies->value.present =
    ...
    config_per_mbsfn_area_item =
        &mcch_related_bcch_config_per_mbsfn_area_item_ies->value.choice.MCCHrelatedBCCH_ConfigPerMBSFNArea_Item;
    {
      config_per_mbsfn_area_item->pdcchLength =
          m2ap_setup_resp->mcch_config_per_mbsfn[i].pdcch_length; // M2AP_MCCHrelatedBCCH_ConfigPerMBSFNArea_Item__pdcchLength_s1;
      ...
      config_per_mbsfn_area_item->repetitionPeriod =
          m2ap_setup_resp->mcch_config_per_mbsfn[i]
              .repetition_period; // M2AP_MCCHrelatedBCCH_ConfigPerMBSFNArea_Item__repetitionPeriod_rf32;
      config_per_mbsfn_area_item->modificationPeriod =
          m2ap_setup_resp->mcch_config_per_mbsfn[i]
              .modification_period; // M2AP_MCCHrelatedBCCH_ConfigPerMBSFNArea_Item__modificationPeriod_rf512;
      ...
      config_per_mbsfn_area_item->subframeAllocationInfo.buf[0] =
          (uint8_t)((m2ap_setup_resp->mcch_config_per_mbsfn[i].subframe_allocation_info & 0x3F) << 2);
      ...
      config_per_mbsfn_area_item->modulationAndCodingScheme =
          m2ap_setup_resp->mcch_config_per_mbsfn[i]
              .mcs; // M2AP_MCCHrelatedBCCH_ConfigPerMBSFNArea_Item__modulationAndCodingScheme_n2;
...
int MCE_send_MCE_CONFIGURATION_UPDATE(instance_t instance, module_id_t du_mod_idP){
  ...
  config_per_mbsfn_area_item = &mcch_related_bcch_config_per_mbsfn_area_item_ies->value.choice.MCCHrelatedBCCH_ConfigPerMBSFNArea_Item;
  {
    ...
    config_per_mbsfn_area_item->modulationAndCodingScheme =
        M2AP_MCCHrelatedBCCH_ConfigPerMBSFNArea_Item__modulationAndCodingScheme_n2;
    asn1cSeqAdd(&ie->value.choice.MCCHrelatedBCCH_ConfigPerMBSFNArea.list, mcch_related_bcch_config_per_mbsfn_area_item_ies);
  }
