...

{
    ...
    for (l = 0; l < 8; l++) {
      ...
      if (msi_flag == 1 && UE_mac_inst[module_idP].pmch_Config[mbms_mch_i] != NULL) {
            LOG_D(MAC,
                  "msi(%d) should be "
                  "allocated:frame(%d),submframe(%d),num_sf_alloc(%d),sf_AllocEnd_r9(%ld),common_num_sf_alloc(%d)\n",
                  mbms_mch_i,
                  frameP,
                  subframe,
                  num_sf_alloc,
            ...
            if (UE_mac_inst[module_idP].pmch_stop_mtch[mbms_mch_i]
                >= UE_mac_inst[module_idP].common_num_sf_alloc /*num_sf_alloc*/) {
...

{
          ...
          for (l = 0; l < 8; l++) {
            ...
            // int common_mbsfn_alloc_offset =
            // UE_mac_inst[module_idP].commonSF_Alloc_r9_mbsfn_SubframeConfig[l]->radioframeAllocationOffset; long
            // common_mbsfn_period  = 1
            // << UE_mac_inst[module_idP].commonSF_Alloc_r9_mbsfn_SubframeConfig[l]->radioframeAllocationPeriod; long
            // commonSF_AllocPeriod = 4 << UE_mac_inst[module_idP].commonSF_AllocPeriod_r9;
          ...
          for (l = 0; l < 8; l++) {
            ...
            // int common_mbsfn_alloc_offset =
            // UE_mac_inst[module_idP].commonSF_Alloc_r9_mbsfn_SubframeConfig[l]->radioframeAllocationOffset;
            long common_mbsfn_period =
                1 << UE_mac_inst[module_idP].commonSF_Alloc_r9_mbsfn_SubframeConfig[l]->radioframeAllocationPeriod;
            long commonSF_AllocPeriod = 4 << UE_mac_inst[module_idP].commonSF_AllocPeriod_r9;
