...
static void f1_du_configuration_update_ack_f1ap(sctp_assoc_t assoc_id, const f1ap_gnb_du_configuration_update_acknowledge_t *ack){
...
void mac_rrc_dl_f1ap_init(nr_mac_rrc_dl_if_t *mac_rrc)
{
  ...
  mac_rrc->f1_du_config_update_ack = f1_du_configuration_update_ack_f1ap;
