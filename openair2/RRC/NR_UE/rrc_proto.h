...
void rrc_ue_process_sidelink_Preconfiguration(NR_UE_RRC_INST_t *rrc_inst, int sync_ref, instance_t Mod_idP);

void nr_rrc_ue_decode_NR_SBCCH_SL_BCH_Message(const module_id_t module_id,
                                              const uint8_t gNB_index,
                                              const frame_t frame,
                                              const int slot,
                                              uint8_t* pduP,
