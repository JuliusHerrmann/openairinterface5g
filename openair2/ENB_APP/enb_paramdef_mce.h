...
#define MCE_NETPARAMS_DESC                                                                                           \
  {                                                                                                                  \
    {MCE_CONFIG_STRING_MCE_INTERFACE_NAME_FOR_M2_ENB,                                                                \
     NULL,                                                                                                           \
     0,                                                                                                              \
     .strptr = &mce_interface_name_for_m2_enb,                                                                       \
     .defstrval = "lo",                                                                                              \
     TYPE_STRING,                                                                                                    \
     0},                                                                                                             \
        ...
        {MCE_CONFIG_STRING_MCE_INTERFACE_NAME_FOR_M3_MME,                                                            \
         NULL,                                                                                                       \
         0,                                                                                                          \
         .strptr = &mce_interface_name_for_m3_mme,                                                                   \
         .defstrval = NULL,                                                                                          \
         TYPE_STRING,                                                                                                \
         0},                                                                                                         \
