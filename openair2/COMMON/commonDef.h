...
#define NAS_IMSI2STR(iMsI_t_PtR, iMsI_sTr, MaXlEn)                                               \
  {                                                                                              \
    int l_offset = 0;                                                                            \
    int l_ret = 0;                                                                               \
    l_ret = snprintf(iMsI_sTr + l_offset,                                                        \
                     MaXlEn - l_offset,                                                          \
                     "%u%u%u%u%u",                                                               \
                     iMsI_t_PtR->u.num.digit1,                                                   \
                     iMsI_t_PtR->u.num.digit2,                                                   \
                     iMsI_t_PtR->u.num.digit3,                                                   \
                     iMsI_t_PtR->u.num.digit4,                                                   \
    ...
    if (l_ret > 0) {                                                                             \
      ...
      l_ret = snprintf(iMsI_sTr + l_offset,                                                      \
                       MaXlEn - l_offset,                                                        \
                       "%u%u%u%u%u%u%u%u",                                                       \
                       iMsI_t_PtR->u.num.digit7,                                                 \
                       iMsI_t_PtR->u.num.digit8,                                                 \
                       iMsI_t_PtR->u.num.digit9,                                                 \
                       iMsI_t_PtR->u.num.digit10,                                                \
                       iMsI_t_PtR->u.num.digit11,                                                \
                       iMsI_t_PtR->u.num.digit12,                                                \
                       iMsI_t_PtR->u.num.digit13,                                                \
                       iMsI_t_PtR->u.num.digit14);                                               \
    }                                                                                            \
...
#define GUTI2STR(GuTi_PtR, GuTi_StR, MaXlEn)                                                                                       \
  {                                                                                                                                \
    ...
    int l_ret = 0;                                                                                                                 \
    l_ret +=                                                                                                                       \
        snprintf(GuTi_StR + l_offset,                                                                                              \
                 MaXlEn - l_offset,                                                                                                \
                 "%03u.",                                                                                                          \
                 GuTi_PtR->gummei.plmn.MCCdigit3 * 100 + GuTi_PtR->gummei.plmn.MCCdigit2 * 10 + GuTi_PtR->gummei.plmn.MCCdigit1);  \
    if (l_ret > 0) {                                                                                                               \
      l_offset += l_ret;                                                                                                           \
    } else {                                                                                                                       \
      l_offset = MaXlEn;                                                                                                           \
    ...
    if (GuTi_PtR->gummei.plmn.MNCdigit1 != 0xf) {                                                                                  \
      l_ret +=                                                                                                                     \
          snprintf(GuTi_StR + l_offset,                                                                                            \
                   MaXlEn - l_offset,                                                                                              \
                   "%03u|%04x|%02x|%08x",                                                                                          \
                   GuTi_PtR->gummei.plmn.MNCdigit3 * 100 + GuTi_PtR->gummei.plmn.MNCdigit2 * 10 + GuTi_PtR->gummei.plmn.MNCdigit1, \
                   GuTi_PtR->gummei.MMEgid,                                                                                        \
                   GuTi_PtR->gummei.MMEcode,                                                                                       \
                   GuTi_PtR->m_tmsi);                                                                                              \
    } else {                                                                                                                       \
      l_ret += snprintf(GuTi_StR + l_offset,                                                                                       \
                        MaXlEn - l_offset,                                                                                         \
                        "%02u|%04x|%02x|%08x",                                                                                     \
                        GuTi_PtR->gummei.plmn.MNCdigit2 * 10 + GuTi_PtR->gummei.plmn.MNCdigit1,                                    \
                        GuTi_PtR->gummei.MMEgid,                                                                                   \
                        GuTi_PtR->gummei.MMEcode,                                                                                  \
                        GuTi_PtR->m_tmsi);                                                                                         \
    }                                                                                                                              \
